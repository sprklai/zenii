...
/** @typedef {{}} Settings_About_Disclaimer_BodyInputs */

const en_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const zh_cn2_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const es_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const ja_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const hi_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const pt_br2_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const ko_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
const fr_settings_about_disclaimer_body = /** @type {(inputs: Settings_About_Disclaimer_BodyInputs) => LocalizedString} */ () => {
...
*
* @param {Settings_About_Disclaimer_BodyInputs} inputs
* @param {{ locale?: "en" | "zh-CN" | "es" | "ja" | "hi" | "pt-BR" | "ko" | "fr" }} options
* @returns {LocalizedString}
*/
export const settings_about_disclaimer_body = /** @type {((inputs?: Settings_About_Disclaimer_BodyInputs, options?: { locale?: "en" | "zh-CN" | "es" | "ja" | "hi" | "pt-BR" | "ko" | "fr" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_About_Disclaimer_BodyInputs, { locale?: "en" | "zh-CN" | "es" | "ja" | "hi" | "pt-BR" | "ko" | "fr" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_settings_about_disclaimer_body(inputs)
	if (locale === "zh-CN") return zh_cn2_settings_about_disclaimer_body(inputs)
	if (locale === "es") return es_settings_about_disclaimer_body(inputs)
	if (locale === "ja") return ja_settings_about_disclaimer_body(inputs)
	if (locale === "hi") return hi_settings_about_disclaimer_body(inputs)
	if (locale === "pt-BR") return pt_br2_settings_about_disclaimer_body(inputs)
	if (locale === "ko") return ko_settings_about_disclaimer_body(inputs)
	return fr_settings_about_disclaimer_body(inputs)
});