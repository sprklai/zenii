...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            wiki_graph_pre_ticks: 80,
            wiki_graph_initial_alpha: 0.5,
            wiki_graph_alpha_decay: 0.02,
            wiki_graph_link_distance: 120.0,
            wiki_graph_charge_strength: -350.0,
            wiki_graph_collide_radius: 40.0,
            wiki_graph_center_force_strength: 0.01,
            wiki_graph_cluster_force_strength: 0.06,
            wiki_graph_cluster_radius_factor: 0.40,
            wiki_graph_cluster_scatter: 120.0,
